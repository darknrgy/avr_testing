...
Queue Queue_create(uint8_t queue_size){
	...
	instance.queue = (QueueElement*) malloc(queue_size * sizeof(QueueElement));
...
void Queue_enqueue(Queue *instance, QueueElement value){
...
QueueElement Queue_dequeue(Queue *instance){
